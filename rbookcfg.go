...
func (c *RbookConfig) DefineFlags(fs *flag.FlagSet) {
	...
	fs.StringVar(&c.RbookFilePath, "path", "", "path to the .rbook file to read and append to. this is also the default command line argument, so -path can be omitted in front of the path")
}
